const experiences = [
    {
        ...
        company: "Solera Inc.",
        description:
        "Leading full stack developer for in house team",
...
export const Experience = () => {
    ...
    <div
        className="absolute top-1/2 lwft-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl -translate-y-1/2"
    />
            ...
            <div className="space-y-12">
                ...
                >
                    ...
                    <div className={`glass p-6 rounded-2xl border border-primary/30 hover:border-primary/50 transition-all duration-500`}>
                        ...
                        <p className="text-muted-foreground">{exp.compnay}</p>
                        ...
                        <div 
                            ...
                            <span className="px-3 py-1 bg-surface text-xs rounded-full text-muted-foreground">{tech}</span>
                        ))}</div>
                    </div>
                    </div>
                </div>
